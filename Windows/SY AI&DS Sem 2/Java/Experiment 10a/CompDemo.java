...
class CompDemo {
    public static void main(String args[]) {
        ...
        JTextField t1 = new JTextField("Sammed Sagare");
        JLabel l2 = new JLabel("Address");
        JTextArea a1 = new JTextArea("Pune, India");
        JButton b1 = new JButton("Submit");
        JLabel l3 = new JLabel("City");
        JCheckBox c1 = new JCheckBox("Pune");
        JCheckBox c2 = new JCheckBox("Mumbai");
        JCheckBox c3 = new JCheckBox("Bengaluru");
        JCheckBox c4 = new JCheckBox("Manali");
        JLabel l4 = new JLabel("Student");

        JRadioButton r1 = new JRadioButton("Yes", null, false);
        JRadioButton r2 = new JRadioButton("No", null, false);
